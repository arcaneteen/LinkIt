      ...
      <section className={styles.background + " min-h-screen flex justify-center items-center"}>
        <div className="main">
            ...
            <span className='flex flex-row '>
              <h1 className="text-2xl font-bold text-center">Avail tag of top creators</h1>
              <img className='w-7 mr-2' src="/svg/tick.svg" alt="" />
              </span>
              <p className='text-center'>Use One link to gather all your Social Accounts</p>
              <p className='text-center py-5 font-bold text-green-900'>Start by Registering here!</p>
