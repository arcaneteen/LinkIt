    ...
    return (
        ...
        <header className='flex flex-row justify-between items-center'>
            <div className="flex flex-col md:flex-row p-5">
                ...
                <button className='inline-flex w-full md:w-auto px-5 py-3 text-blue-800 font-bold hover:text-purple-700 hover:bg-blue-100 rounded-md mb-3 border-2 border-white-500'>
                    <img src="/svg/url.svg" className='w-6 mr-3'/>
                    Edit Links
                </button>
                </Link>
                <Link href="/edit/profile">
                <button className='inline-flex w-full md:w-auto px-5 py-3 text-pink-900 font-bold hover:text-purple-700 hover:bg-blue-100 rounded-md mb-3 border-2 border-white-500 md:ml-4'>
